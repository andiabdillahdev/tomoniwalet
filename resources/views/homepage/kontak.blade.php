                        ...
                        <div class="card-kontak">
                            <form>
                                <div class="row row-group">
                                    ...
                                    <div class="col-sm-10">
                                    <input type="text" class="form-control form-general" id="nama_">
                                    </div>
                                </div>
                                <div class="row row-group">
                                    <label for="email_" class="col-sm-2 col-form-label">E-mail</label>
                                    <div class="col-sm-10">
                                    <input type="email" class="form-control form-general" id="email_">
                                    </div>
                                </div>
                                <div class="row row-group">
                                    <label for="perihal_" class="col-sm-2 col-form-label">Perihal</label>
                                    <div class="col-sm-10">
                                    <input type="text" class="form-control form-general" id="perihal_">
                                    </div>
                                </div>
                                <div class="row row-group">
                                    ...
                                    <div class="col-sm-10">
                                    <!-- <input type="text" class="form-control form-general" id="perihal_"> -->
                                    <textarea name="" class="form-control form-general" rows="3"></textarea>
                                    </div>
                                </div>
                                <div class="d-flex justify-content-center row-group">
                                   <button class="tm_button tm_primary tm-md">Kirim</button>
                                </div>
