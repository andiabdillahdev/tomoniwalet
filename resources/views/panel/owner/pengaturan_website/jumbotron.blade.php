                        ...
                        <div class="container">
                            <form id="form-hero-section" class="forms-sample">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $hero[0]['title_gambar_hero'] }}"
                                        class="form-control form-control-sm" name="title_gambar_hero" id="judul_gambar_"
                                        placeholder="Judul Gambar">
                                    <small class="text-danger error-notif" id="title_gambar_hero"></small>
                                </div>
                                <div class="form-group">
                                    <label for="text_hero_">Text Hero</label>
                                    <textarea name="text_hero" style="width:100%" id="text_hero_"
                             ...
                             {{ $hero[0]['text_hero'] }}
                                ...
                                <button type="button"
                                    onclick="store_page('form-hero-section','owner/pengaturan-website/jumbotronStore/{{ $hero[0]['id'] }}','owner/pengaturan-website/jumbotron')"
                    ...
                    <div class="card-body">
                        ...
                        <form id="form-hero-kategori-section" class="forms-sample">
                            ...
                            @foreach ($kategori_hero as $key => $value)
                                ...
                                <div class="form-group">
                                    <label>Pilih Kategori {{ $key + 1 }} </label>
                            ...
                            <button type="button"
                                onclick="store_page('form-hero-kategori-section','owner/pengaturan-website/hero-kategori','owner/pengaturan-website/jumbotron')"
                                class="btn btn-primary mr-2">Submit</button>
