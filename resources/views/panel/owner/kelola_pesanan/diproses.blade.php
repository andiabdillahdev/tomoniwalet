...
@push('scripts')
    <script>
        $(function() {
            ...
            $(document).on('click', '.btn-proccess', function(e) {
                e.preventDefault();

                let data_id = $(this).attr('data-id');
                $('.proccess-action').attr('data-id', data_id);
                $.ajax({
                    url: host + "/owner/pesanan/getfotobukti",
                    method: "GET",
                    data: {
                        id: data_id
                    },
                    success: function(data) {
                        $('#foto_bukti').attr('src', host + '/uploads/bukti_pembayaran/' + data)
                    }
                });
            });

            $(document).on('click', '.proccess-action', function(e) {
                e.preventDefault();
